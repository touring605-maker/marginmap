        ...
        {costs.length > 0 && (
          <div className="bg-white dark:bg-slate-900 border border-border rounded-2xl shadow-sm overflow-hidden">
            <div className="p-6 border-b border-border">
              ...
              <p className="text-sm text-muted-foreground">{costs.length} cost items</p>
            </div>
                  ...
                  {costs.map((c) => (
                    <tr key={c.id} className="border-t border-border/50">
                      ...
                      <td className="px-6 py-3">
                        <span className="px-2 py-0.5 rounded-full text-xs bg-slate-100 dark:bg-slate-800">{c.type}</span>
                      </td>
        ...
        {values.length > 0 && (
          <div className="bg-white dark:bg-slate-900 border border-border rounded-2xl shadow-sm overflow-hidden">
            <div className="p-6 border-b border-border">
              ...
              <p className="text-sm text-muted-foreground">{values.length} value drivers</p>
            </div>
            <div className="overflow-auto">
              <table className="w-full text-sm">
                <thead className="bg-slate-50 dark:bg-slate-800/50">
                ...
                <tbody>
                  {values.map((v) => (
                    <tr key={v.id} className="border-t border-border/50">
                      ...
                      <td className="px-6 py-3">
                        <span className="px-2 py-0.5 rounded-full text-xs bg-slate-100 dark:bg-slate-800">{v.type}</span>
                      </td>
