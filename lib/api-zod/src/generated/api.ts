...
export const GetFinancialModelResponse = zod.object({
  cashFlows: zod.array(
    zod.object({
      ...
      cumulativeCosts: zod.number(),
      cumulativeBenefits: zod.number(),
      cumulativeNpv: zod.number(),
      runningIrr: zod.number().nullable(),
      projectCosts: zod.number(),
      currentStateCosts: zod.number(),
      futureStateCosts: zod.number(),
    }),
  ),
  npv: zod.number(),
